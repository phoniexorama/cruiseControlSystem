pipeline {
    ...
    environment {
        ...
        CRS_CONTROLLER_ERT_RTW_PATH = "Code\\codegen\\crs_controller_ert_rtw\\" // Path to the folder
        ...
        stage('Verify') {
            ...
            steps {
                script {
                    ...
                    bat "${ZIP_PATH} a -tzip ${CODE_GEN_OUTPUT_PATH} ${CRS_CONTROLLER_ERT_RTW_PATH}* -r" // Use -r to include contents recursively
